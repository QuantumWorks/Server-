...
name=World Creator
description=World creator by QuantomWorks
version=0.3
author=Quantom Team
class=world
...
class world implements Plugin{
	...
	public function init(){
		$this->api->console->register("world", "<command> [parameters...]", array($this, "command"));
		$this->api->console->alias("w", "world");
		$this->api->console->alias("we", "world export");
		$this->api->console->alias("wu", "world unload");
		$this->api->console->alias("wl", "world load");
		$this->api->console->alias("wg", "world generate");
		$this->config = new Config($this->api->plugin->configPath($this)."config.yml", CONFIG_YAML, array(
			"default-generator" => "SuperflatGenerator",
			"autogenerate" => false,
			"autoload" => array(),
		));
		console("[world] Loading levels...");
