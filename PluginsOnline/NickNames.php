...
class Nicknames implements Plugin{
	...
	public function init(){
		...
		$this->api->console->register("nick", "<[blank]/[player name]>  changes your user name (ops only!)", array($this, "NickPlayer"));
		$this->api->console->register("realname", "<[blank]/[player name]>  Gets real users names", array($this, "getRealName"));
